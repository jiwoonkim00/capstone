...
try:
    ...
    result = session.execute(text("SELECT id, title, ingredients, tools, content FROM recipe"))
    ...
    # 인덱스 초기화
    logger.info("📁 새로운 FAISS GPU 인덱스 생성")
